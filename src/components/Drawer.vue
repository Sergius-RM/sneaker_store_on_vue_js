...
// пример пропс дрилла
// свойство closeDrawer с помощью деструктуризации втаскиваем из глобальной переменной cart
...
<template>
  ...
  <div
    class="flex flex-col justify-between fixed h-full z-10 top-0 h-full right-0 w-96 bg-white px-10 py-7 overflow-auto"
  >
    ...
    <div class="flex flex-col flex-1 justify-between">
      <div v-if="!totalPrice" class="flex h-full items-center">
        <InfoBlock
          title="Корзина пуста"
          description="Ни один товар не добавлен в корзину"
